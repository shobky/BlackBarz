    ...
    return (
        <nav className='navigation-container'>
            ...
            <div id='navMb' className='nav_links-group__inActive nav_links-pc'>
                {
                    currentUser?.uid === 'Ac0cCKWKxUWfaGe2HcHL1LX2TWD2'
                        || currentUser?.uid === 'OqWEn6fJcZNgyLEskceO6RCa1qV2'
                        || currentUser?.uid === '14ntzuPO1safPwDfmKDrTp2CcQ63'
                        || currentUser?.uid === 'u0kCx1kiHkavId1Boefqu4TFuhF3' ?
